...
- [x] **Claude Code parity program — waves 1–2 of 5 closed, wave 3 open.** Row-level build order
  ...
  giving the session a ledger, and agent files gaining `tools`/`disallowedTools`
  (the other eight fields refused by name): 43 HAVE/ALIAS,
  16 PARTIAL, 43 GAP (**42.2%**), 21 rows left in the wave, led by parallel tool
