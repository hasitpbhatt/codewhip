...
- [x] **Claude Code parity program — waves 1–2 of 5 closed, wave 3 open.** Row-level build order
  ...
  (the other eight fields refused by name), and `ask_user` letting the model put
  one question back to the human: 43 HAVE/ALIAS,
  17 PARTIAL, 42 GAP (**42.2%**), 20 rows left in the wave, led by parallel tool
