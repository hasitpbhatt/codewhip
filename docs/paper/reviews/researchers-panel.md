...
- **Rules File Backdoor (Pillar Security, 2025) → CVE-2025-54136 (Cursor)** and ~8 more prompt-injection CVEs across Copilot/incumbent/Cursor/Amazon Q/Codex in 12 months — the repo-instruction-file half of your "persistence surface" is already product-confirmed.
...
- [AI coding tools' config files as attack surface — 8+ injection CVEs across Copilot/incumbent/Cursor/Amazon Q/Codex](https://yage.ai/share/ai-coding-config-injection-en-20260422.html)
