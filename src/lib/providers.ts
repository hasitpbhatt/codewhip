...
export const FREE_CHAIN: readonly FreeProviderEntry[] = [
  ...
  // 2026-09-16: new providers — AnyRouter (strong) and community gateways (volatile).
  { id: "anyrouter", freeOffer: "AnyRouter free tier — 184+ models across 17 providers", keyNeeded: "free-key", limits: "anyrouter/free models at $0/token, 1000 req/day; BYOK $0 markup" },
  { id: "zukijourney", freeOffer: "zukijourney community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies, health-weighted auto-routing will deprioritize if unreliable" },
  { id: "nagaai", freeOffer: "NagaAI community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies" },
  { id: "zanityai", freeOffer: "ZanityAI community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies" },
  { id: "kimetsu", freeOffer: "Kimetsu community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies" },
  { id: "navyapi", freeOffer: "NavyAPI community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies" },
  { id: "mnn", freeOffer: "MNN community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies" },
  { id: "hcap", freeOffer: "hcap.ai community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies" },
  { id: "voltai", freeOffer: "VoltAI community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; Render-hosted, cold starts possible" },
  { id: "electronhub", freeOffer: "ElectronHub community gateway — free tier", keyNeeded: "free-key", limits: "community gateway; stability varies" },
];
